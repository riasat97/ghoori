...
@endsection
@section('metatags')
    <meta property="og:title" content="Ghoori Hot Deals" />
    <meta property="og:site_name" content="ghoori.com.bd"/>
    <meta property="og:url" content="{{URL::route('deals')}}" />
    <meta property="og:description" content="Get up to 50% “Hot Deal” discounts in more than 500 products at ghoori.com.bd. Call 09612000888 to know more." />
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="gh_home_panel">
                                    <img u="image" src="{{ URL::asset('img/home/slider/hot-deals-banner.jpg') }}" alt="" style="width:100%">
