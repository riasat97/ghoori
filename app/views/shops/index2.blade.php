        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div id="slider1_container" class="home-content-box" style="position: relative; margin: 0 auto;
                    top: 0px; left: 0px; width: 1152px; height: 288px; overflow: hidden;">
                    <!-- Loading Screen -->
                    ...
                    <!-- Slides Container -->
                    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1152px;
                        height: 288px; overflow: hidden;">
                        <div>
                            <img u="image" src2="{{ URL::asset('img/home/slider/hny.jpg') }}" alt="" style="width:100%">

                        </div>
                        <div>
                            <a href="{{route('poabaropage')}}">
                                <img u="image" src2="{{ URL::asset('img/home/slider/poa12.jpg') }}" alt="" style="width:100%">
                            </a>

                        </div>
                        <div>
                            <img u="image" src2="{{ URL::asset('img/home/slider/banner1.jpg') }}" alt="" style="width:100%">

                        </div>
                        <div>
                            <img u="image" src2="{{ URL::asset('img/home/slider/banner2.jpg') }}" alt="" style="width:100%">

                        </div>
                        <div>
                            <img u="image" src2="{{ URL::asset('img/home/slider/banner3.jpg') }}" alt="" style="width:100%">
                                            ...
                                            <div class="bbuttom">
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                                        <h2 class="gh_home_panel_title"><a href="{{route('deals')}}">পোয়া১২</a></h2>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4 col-md-4 text-right">
                                                        <a class="btn btn-link" href="{{route('deals')}}"><h5>View more</h5></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="collections">
                                                <div class="collections-left-panel">
                                                    <img src="{{asset('img/home/campaign/hot-deals.jpg')}}" alt="">
                                                </div>
                                                <div class="top-items">
