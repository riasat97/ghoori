        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <label>Add discount to attract more customers.</label>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <div class="radio radio-inline">
                            <label>
                                <input name="discount" type="radio" value="10" required>10% Discount
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <div class="radio radio-inline">
                            <label>
                                <input name="discount" type="radio" value="26" required>26% Discount
                            </label>
                        </div>
                    </div>
                </div>
