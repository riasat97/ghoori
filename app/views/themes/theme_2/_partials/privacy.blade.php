...
@section('title')
    <title>Privacy Policy | {{$shop->title}}</title>
@stop
...
@section('tab-content')
    {{HTML::style('themes/theme_2/css/privacy.css')}}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 privacy-heading">
                            <p>Privacy Policy</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row no-left-right-margin">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 privacy-tab">
