...
!function(a){"use strict";
    ...
    var e=function(b,c){
        var e=this;
        if(this.options=c,this.$tableWrapper=null,this.$tableScrollWrapper=a(b),this.$table=a(b).find("table"),1!==this.$table.length)
        ...
        this.$tableClone=null,this.$stickyTableHeader=null,
        ...
        function(){e.$dropdownContainer.find("input").trigger("updateCheck"),
    ...
    e.prototype.wrapTable=function(){this.$tableScrollWrapper.wrap('<div class="table-wrapper"/>'),
